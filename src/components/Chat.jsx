...
const Chat = () => {
    ...
    return (
        <div className="nav-item absolute right-5 md:left-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
            <div className="flex justify-between items-center">
                <div className="flex gap-3">
                    <p className="font-semibold text-lg dark:text-gray-200">چت ها</p>
